# Generated by Powerlevel10k configuration wizard on 2021-01-19 at 11:08 -03.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=252  # (default: 232 // negro)
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=8    # (default: 7 // Gris claro)
  # Custom icon.
